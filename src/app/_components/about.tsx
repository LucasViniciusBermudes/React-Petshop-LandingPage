          ...
          >
            ...
            <div className="flex gap-2">
              <a
                ...
                className="bg-[#E84C3D] text-white flex items-center justify-center w-fit gap-w px-4 py-2 rounded-md"
              >
              ...
              <a
                target="_blank"
                href="https://maps.app.goo.gl/noGnRParEAHfNose8"
                className="flex items-center justify-center w-fit gap-w px-4 py-2 rounded-md"
              >
