  ...
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative" data-aos="flip-up" data-aos-delay="500">
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {services.map((item, index) => (
                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        target="_blank"
                        href={`https://wa.me/5519987142390?text=Olá, vim pelo site e gostaria de mais informações sobre ${item.title}!`}
          ...
          <button
            className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-7 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 cursor-pointer"
            onClick={scrollNext}
          >
